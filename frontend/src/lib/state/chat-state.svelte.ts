...
class ChatState {
     ...
     * @param role the role of the user that wrote the message
     * @param content what was written in the message
     */
     ...
     * appends a token to the last message in the chat, if 
     * the last message was from the assistant
     * @param token the last string token generated by the assistant
     */
